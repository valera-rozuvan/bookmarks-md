...
4. [Kleptography (Wikipedia)](https://en.wikipedia.org/wiki/Kleptography)
    - [Dual_EC_DRBG (Wikipedia)](https://en.wikipedia.org/wiki/Dual_EC_DRBG)
    - [NIST SP 800-90A (Wikipedia)](https://en.wikipedia.org/wiki/NIST_SP_800-90A)
...
1. [Matthew Green's blog | A Few Thoughts on Cryptographic Engineering](https://blog.cryptographyengineering.com/)

## Lecture notes

1. [Computer and Network Security by Avinash Kak](https://engineering.purdue.edu/kak/compsec/)
